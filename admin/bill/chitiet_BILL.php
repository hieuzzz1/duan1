            ...
            <div class="col danhmucsp-content">
                ...
                <div class="order-summary">
                    <div class="order-details customer-details">
                        ...
                        <div class="Update_bil_chitiet"><a href="#" class="openModalButton" data-bs-toggle="modal"
                                data-bs-target="#customModal_<?php echo $id; ?>">
                                Sửa thông tin
                            </a></div>


                        <div class="modal fade" id="customModal_<?php echo $id; ?>" data-bs-backdrop="static"
                            data-bs-keyboard="false" tabindex="-1" aria-labelledby="customModalLabel_<?php echo $id; ?>"
                            aria-hidden="true">
                                    ...
                                    <form action="index.php?act=update_bill_chitiet" method="post">
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="ten_user"
                                                    value="<?=$bill_name?>">
                                            </div>
                                            <div class="mb-3">
                                                <label for="recipient-name" class="col-form-label">Địa chỉ</label>
                                                <input type="text" class="form-control" name="diachi_user"
                                                    value="<?=$bill_diachi?>">
                                            </div>
                                            <div class="mb-3">
