        ...
        <div class="row">
            <div class="col danhmucsp-content">
                ...
                <div class="bangdanhmuc">
                    <form action="index.php?act=update_bl" method="post">
                        <?php
                        if(is_array($binhluan)){
                            extract($binhluan);;
                        }
                    ?>
                    <p>Trả lời bình luận của khách hàng</p>
                    <input type="text" value="<?php echo $noidung;?>">
                    <p>ADMIN trả lời bình luận</p>
                    <input type="text" name="phanhoi" value="<?php if(isset($phanhoi)&&($phanhoi!="")) echo $phanhoi;?>">
